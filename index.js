import{a as c,i,R as y}from"./assets/vendor-CaGxMn-M.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const E=document.querySelector(".js-open-menu"),S=document.querySelector(".js-close-menu"),p=document.querySelector(".js-menu"),v=document.body,$=document.querySelectorAll(".mobile-menu__link");E.addEventListener("click",()=>{p.classList.add("is-open"),v.classList.add("no-scroll")});S.addEventListener("click",()=>{p.classList.add("closing"),v.classList.remove("no-scroll"),setTimeout(()=>{p.classList.remove("is-open","closing")},200)});$.forEach(e=>{e.addEventListener("click",()=>{p.classList.remove("is-open"),v.classList.remove("no-scroll")})});const k=document.querySelector(".loader");function M(){k.classList.remove("is-hidden")}function q(){k.classList.add("is-hidden")}c.defaults.baseURL="https://sound-wave.b.goit.study/api";document.querySelector(".loader");const T=e=>{const t=Math.floor(e/6e4),n=Math.floor(e%6e4/1e3);return`${t}:${n<10?"0":""}${n}`};async function A(e){if(!e){i.error({title:"Error",message:"Artist ID is missing."});return}B();try{const t=await c.get(`/artists/${e}`),r=(await c.get(`/artists/${e}/albums`)).data.albumsList||[],s=t.data,a=L("artists");document.body.appendChild(a),h(a),C(a,s,r)}catch(t){console.error("Error fetching artist details:",t),i.error({title:"Error",message:"Failed to load artist details."})}finally{F()}}function L(e){const t=document.createElement("div");return t.className=`${e}-modal`,t.innerHTML=`
  ...
  `,t}function B(){let e=document.querySelector(".global-loader");e||(e=document.createElement("div"),e.className="global-loader",e.innerHTML='<div class="loader"></div>',document.body.appendChild(e)),e.classList.remove("hidden")}function F(){const e=document.querySelector(".global-loader");e&&e.classList.add("hidden")}function h(e,t){const n=e.querySelector(".modal-close-btn");function r(){e.remove(),typeof t=="function"&&t(),document.removeEventListener("keydown",s),e.removeEventListener("click",a)}n.addEventListener("click",r);const s=o=>{o.key==="Escape"&&r()};document.addEventListener("keydown",s);const a=o=>{o.target===e&&r()};e.addEventListener("click",a)}function C(e,t,n){const r=e.querySelector(".artists-modal-content");r.innerHTML=`
            <span class="modal-close-btn-wraper">
            <button type="button" class="modal-close-btn" aria-label="Close"> <svg class="SVG-icon"
              width="24" height="16">
              <use href="/icon-sprite.svg#icon-clouse"></use>
    ...
    `,h(e)}c.defaults.baseURL="https://sound-wave.b.goit.study/api";const g=document.querySelector(".artists-list"),d=document.querySelector(".load-more-btn");let u=1;const O=8;w();d.addEventListener("click",()=>{u+=1,w()});g.addEventListener("click",function(e){const t=e.target.closest(".learn-more-btn");if(!t)return;const n=t.dataset.id;A(n)});async function R(e){return(await c.get("/artists",{params:{page:e,limit:O}})).data}function N(e,t=20){if(!e)return"";const n=e.indexOf("."),r=e.split(" ");if(n!==-1){const s=e.substring(0,n+1);if(s.split(" ").length<=t)return s}return r.length>t?r.slice(0,t).join(" ")+"...":e}function j(e,t=!1){const n=e.map(({_id:r,strArtist:s,strArtistThumb:a,genres:o,strBiographyEN:f})=>`
